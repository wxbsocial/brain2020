from model_wrapper import MLP_Wrapper_A, MLP_Wrapper_B, MLP_Wrapper_C, MLP_Wrapper_D, MLP_Wrapper_E, MLP_Wrapper_F,MLP_Wrapper_COPD
...
def mlp_COPD_train(exp_idx, repe_time, accu, config):
    mlp_setting = config
    for i in range(repe_time):
        mlp = MLP_Wrapper_COPD(imbalan_ratio=mlp_setting['imbalan_ratio'],
                            fil_num=mlp_setting['fil_num'],
                            drop_rate=mlp_setting['drop_rate'],
                            batch_size=mlp_setting['batch_size'],
                            balanced=mlp_setting['balanced'],
